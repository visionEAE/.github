...
Same picture as [gcp-deployment-feasibility.md](https://github.com/visionEAE/student360-infra/blob/main/docs/gcp-deployment-feasibility.md): Cloud Run, Pub/Sub,
